...
;(function(window, document) {
  ...
  // Get theme
  var theme = theme || markdownEl.getAttribute('theme') || 'chaitin';
  theme = "chaitin";
  ...
  var linkEl = document.createElement('link');
  linkEl.href = '/css/strapdown.min.css';
  linkEl.rel = 'stylesheet';
  document.head.appendChild(linkEl);

  var linkEl = document.createElement('link');
  linkEl.href = '/css/bootstrap-responsive.min.css';
  linkEl.rel = 'stylesheet';
  document.head.appendChild(linkEl);
  ...
  if (!navbarEl && titleEl) {
    newNode.innerHTML = '<div class="navbar-inner"> <div class="container">' + 
                        '<div id="headline" class="brand"> <img src="/img/logo.png" title="Chaitin"/></div>' +
                        '<div class="pull-right nav-btn"> <a style="color:#fff;" href="http://chaitin.com"> 官网 </a> <span/> <a style="color:#fff;" href="/">BLOG</a> <a target="_blank" href="http://weibo.com/chaitin"><img src="/img/weibo.png"></a></div>' +
                        '</div> </div>';
  ...
  if (show_toc == 'true') {
    ...
    title.appendChild(document.createTextNode(titleEl.innerText||titleEl.textContent));
